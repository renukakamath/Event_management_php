...
if (isset($_POST['payment'])) {
	...
	$q="insert into otherpayment values(null,'$rid','$amo',curdate(),'catering')";
	insert($q);
	$Q="update cater_request set status='Paid' where request_id='$rid'";
	update($Q);
	alert('successfully');
	return redirect('user_viewcateingrequest.php');
}
...
<table class="table" style="width: 500px;color: white">
			...
			<tr>
				<th> Amount</th>
				<td style=""><input type="number"  value="<?php echo $amo ?>" required="" style="color: white" class="form-control" name="amo"></td>
			</tr>
			<tr>
				<th>C v v</th>
