...
if (isset($_POST['complaint'])) {
	...
	$q="insert into complaint values(null,'$cid','$fee','pending',curdate())";
	insert($q);
	alert('successfully');
	return redirect('catering_sendcomplaint.php');
}
...
<center>
	...
	<form>
     ...
     $q="select * from complaint inner join  catering_team  on catering_team.login_id=complaint.customer_id  where login_id='$cid'";
     $res=select($q);
     $sino=1;
