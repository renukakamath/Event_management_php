...
if (isset($_POST['complaint'])) {
	...
	$q="insert into complaint values(null,'$lid','$fee','pending',curdate())";
	insert($q);
	alert('successfully');
	return redirect('lightsound_sendcomplaint.php');
}
...
<center>
	...
	<form>
     ...
     $q="select * from complaint inner join  lightandsound  on lightandsound.login_id=complaint.customer_id  where login_id='$lid'";
     $res=select($q);
     $sino=1;
