                ...
                <div class="row">
                    <div class="col-12">
                        <div class="text-center text-150">
                            ...
                            <span class="text-default-d3">EVent Management</span>
                        </div>
                    </div>
                </div>
                 <!-- .row -->
...
<?php 
    $q="select * from catering_team where cater_id='$cid'";
$res=select($q);
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div>
                            ...
                            <span class="text-600 text-110 text-blue align-middle"><?php echo $res[0]['cater_name'] ?></span>
                        </div>
                        <div class="text-grey-m2">
                            <div class="my-1">
                            <?php echo $res[0]['place'] ?>
                            </div>
                            <div class="my-1">
                            <?php echo $res[0]['email'] ?>
                            </div>
                            <div class="my-1"><i class="fa fa-phone fa-flip-horizontal text-secondary"></i> <b class="text-600"><?php echo $res[0]['phone'] ?></b></div>
                        </div>
                    </div>
                    <!-- /.col -->
                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                           ...
                           <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1" style="padding-left: 800px;"></i> <span class="text-600 text-90">ID:</span> #111-222</div>
                            ...
                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"  style="padding-left: 800px;"></i> <span class="text-600 text-90">Issue Date:</span> Oct 12, 2019</div>
