...
if (isset($_POST['staffreg'])) {
    ...
    echo$q="insert into login values(null,'$uname','$pwd','lightsound')";
     $id=insert($q);
  echo$q1="insert into lightandsound values(null,'$id','$sid','$fname','$num','$place','$email') ";
   insert($q1);
   alert('sucessfully');
   return redirect('staff_managelightandsound.php');
}
}
 ...
 if (isset($_GET['uid'])) {
 	extract($_GET);
 	 ...
 	 $q="select * from lightandsound where light_sound_id='$uid'";
 	$res=select($q);
 ...
 if (isset($_POST['update'])) {
 	...
 	$q="update lightandsound set light_sound_name='$fname' ,place='$place',phone='$num',email='$email' where light_sound_id='$uid'";
 	update($q);
 	 alert('sucessfully');
   return redirect('staff_managelightandsound.php');
...
if (isset($_GET['did'])) {
	...
	$q="delete from lightandsound where light_sound_id='$did'";
	delete($q);
	alert('sucessfully');
   return redirect('staff_managelightandsound.php');
}
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<br><br><br><br><br>
<center>
<h1 style="font-size: 100px">Manage light sound </h1>
<form method="post">
...
<center>
	...
	<form>
     ...
     $q="select * from lightandsound inner join login using (login_id)  where staff_id='$sid' ";
     $res=select($q);
     $sino=1;
    	...
    	<tr>
    		...
    		<td><?php echo $row['phone'] ?></td>
    			<td><?php echo $row['email'] ?></td>
                    <td><a  class="btn btn-success" href="?did=<?php echo $row['light_sound_id'] ?>">Delete</a></td>
    		   <td><a class="btn btn-success" href="?uid=<?php echo $row['light_sound_id'] ?>">Update</a></td>
