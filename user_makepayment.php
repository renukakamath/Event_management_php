...
if (isset($_POST['payment'])) {
	...
	$q="insert into payment values(null,'$boid','$amo',curdate())";
	insert($q);
	$Q="update booking set booking_status='Paid' where booking_id='$boid'";
	update($Q);
	alert('successfully');
...
<table class="table" style="width: 500px;color: white">
			...
			<tr>
				<th> Amount</th>
				<td style=""><input type="number"  value="<?php echo $package_amount ?>" required="" style="color: white" class="form-control" name="amo"></td>
			</tr>
			<tr>
				<th>C v v</th>
